...
def compute_energy_flux(a_xi_id):
    ...
    #print a_xi.shape
    a1_xi = nc.variables['a_xi_array'][::10,300,:]
    a1_xi_squared = a1_xi**2
    a2_xi = nc.variables['a_xi_array'][::10,400,:]
    a2_xi_squared = a2_xi**2
    a3_xi = nc.variables['a_xi_array'][::10,800,:]
    ...
    title1 = "energy flux at %d cm depth" % (z[300])
    title2 = "energy flux at %d cm depth" % (z[400])
    title3 = "energy flux at %d cm depth" % (z[800])
