...
def HT_filter(dz_id):
    # given a netcdf file with id dz_id

    filenmae = "dz_%d.nc" % dz_id
    #

    # need a filename for the output
    ...
    # copy grid from U ncfile
    nc_ht.createDimension('x', nx)
    nc_ht.createDimension('z', nz)
    nc_ht.createDimension('t', nt)
    ...
    # copy grid from Uht ncfile
    nc_lr.createDimension('t', nt)
    nc_lr.createDimension('x', nx)
    nc_lr.createDimension('z', nz)
